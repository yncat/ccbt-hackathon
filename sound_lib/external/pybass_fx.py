...
BASS_FX_BPM_DecodeGet = func_type(
    ctypes.c_float,
    ctypes.c_ulong,
    ctypes.c_double,
    ctypes.c_double,
...
BASS_FX_BPM_CallbackSet = func_type(
    ctypes.c_bool,
    ctypes.c_ulong,
    BPMPROC,
    ctypes.c_double,
...
BASS_FX_BPM_BeatSetParameters = func_type(
    ctypes.c_bool, ctypes.c_ulong, ctypes.c_float, ctypes.c_float, ctypes.c_float)(
        ('BASS_FX_BPM_BeatSetParameters', bass_fx_module))

# BOOL BASS_FXDEF(BASS_FX_BPM_BeatGetParameters)(DWORD handle, float *bandwidth, float *centerfreq, float *beat_rtime);
BASS_FX_BPM_BeatGetParameters = func_type(
    ctypes.c_bool, ctypes.c_ulong, ctypes.c_float, ctypes.c_float, ctypes.c_float)(
        ('BASS_FX_BPM_BeatGetParameters', bass_fx_module))
