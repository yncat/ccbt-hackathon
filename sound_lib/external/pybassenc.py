...
BASS_Encode_StartLimit = func_type(
    HENCODE,
    ctypes.c_ulong,
    ctypes.c_void_p,
    ctypes.c_ulong,
...
if platform.system() == 'Windows':
    ...
    BASS_Encode_GetACMFormat = func_type(
        ctypes.c_ulong,
        ctypes.c_ulong,
        ctypes.c_void_p,
        ctypes.c_ulong,
    ...
    BASS_Encode_StartACM = func_type(
        HENCODE,
        ctypes.c_ulong,
        ctypes.c_void_p,
        ctypes.c_ulong,
    ...
    BASS_Encode_StartACMFile = func_type(
        HENCODE, ctypes.c_ulong, ctypes.c_void_p, ctypes.c_ulong, ctypes.c_char_p)(
        ('BASS_Encode_StartACMFile', bassenc_module))
...
# HENCODE BASSENCDEF(BASS_Encode_StartCAFile)(DWORD handle, DWORD ftype, DWORD atype, DWORD flags, DWORD bitrate, const char *file);
    BASS_Encode_StartCAFile = func_type(
        HENCODE,
        ctypes.c_ulong,
        ctypes.c_ulong,
        ctypes.c_ulong,
...
# BOOL BASSENCDEF(BASS_Encode_CastInit)(HENCODE handle, const char
# *server, const char *pass, const char *content, const char *name, const
# char *url, const char *genre, const char *desc, const char *headers,
# DWORD bitrate, BOOL pub);
BASS_Encode_CastInit = func_type(
    ctypes.c_byte,
    HENCODE,
    ctypes.c_char_p,
    ctypes.c_char_p,
...
# DWORD BASSENCDEF(BASS_Encode_ServerInit)(HENCODE handle, const char
# *port, DWORD buffer, DWORD burst, DWORD flags, ENCODECLIENTPROC *proc,
# void *user);
BASS_Encode_ServerInit = func_type(
    ctypes.c_ulong,
    HENCODE,
    ctypes.c_char_p,
    ctypes.c_ulong,
