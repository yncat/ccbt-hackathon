...
BASS_MIDI_StreamCreateFileUser = func_type(HSTREAM, ctypes.c_ulong, ctypes.c_ulong, ctypes.POINTER(
    BASS_FILEPROCS), ctypes.c_void_p, ctypes.c_ulong)(('BASS_MIDI_StreamCreateFileUser', bassmidi_module))
...
BASS_MIDI_StreamGetEvents = func_type(
    ...
    ctypes.c_ulong,
    ctypes.c_ulong,
    ctypes.POINTER(BASS_MIDI_EVENT))(
