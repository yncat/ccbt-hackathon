...
# HSTREAM BASSWMADEF(BASS_WMA_StreamCreateFileAuth)(BOOL mem, const void
# *file, QWORD offset, QWORD length, DWORD flags, const char *user, const
# char *pass);
...
BASS_WMA_EncodeOpenNetworkMulti = func_type(
    HWMENCODE, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong, ctypes.POINTER(
        ctypes.c_ulong), ctypes.c_ulong, ctypes.c_ulong)(
            ('BASS_WMA_EncodeOpenNetworkMulti', basswma_module))
# HWMENCODE BASSWMADEF(BASS_WMA_EncodeOpenPublish)(DWORD freq, DWORD
# chans, DWORD flags, DWORD bitrate, const char *url, const char *user,
# const char *pass);
BASS_WMA_EncodeOpenPublish = func_type(
    ...
    ctypes.c_char_p)(
        ('BASS_WMA_EncodeOpenPublish',
         basswma_module))
# HWMENCODE BASSWMADEF(BASS_WMA_EncodeOpenPublishMulti)(DWORD freq, DWORD
# chans, DWORD flags, const DWORD *bitrates, const char *url, const char
