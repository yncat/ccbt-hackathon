...
print("Wand designed by Azusa Miyamura, Character designed by Azusa Miyamura and Ryota Suzuki")
...
def on_motion_receive_notify(sender, data: bytearray):
    ...
    if event_type == 3: # orientation event
        if data[2] == 4: # face down (due to the way the cencors are connected)
            cast()
        else:
            charge()
